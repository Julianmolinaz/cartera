const rules_personales = {
    ...
    lugar_exp: { name: 'lugar de expedicion', rule: 'required|alpha_spaces' },
    fecha_exp: { name: 'fecha de expedicion', rule: 'required' },
    fecha_nacimiento: { name: 'fecha de nacimiento', rule: 'required' },
    lugar_nacimiento: { name: 'lugar de nacimiento', rule: 'required|alpha_spaces' },
...
const rules_economica = {
    ...
    dir_empresa: { name: 'direccion empresa', rule: 'requiredb|regex:^([a-zA-Z0-9-]+[ ]?)+$', required: '' }, // empleado e independiente
    doc_empresa: { name: 'identificacion empresa', rule: 'numeric|required', required: '*' }, // empleado
