        ...
        <div class="panel-body">
          ...
          <div class="form-group">
            <div class="col-md-12">
              ...
              <input type="text" class="form-control" id="razon-social" name="razon_social" value="{{ $variables->razon_social }}">
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-12">
              <label for=""><small>NIT</small></label>
              <input type="text" class="form-control" id="nit" name="nit" value="{{ $variables->nit }}">
            </div>
          </div>
          <div class="form-group">
            <div class="col-md-6">
              <label for=""><small>Tel 1</small></label>
              <input type="text" class="form-control" id="telefono_1" name="telefono_1" value="{{ $variables->telefono_1 }}">
            </div>
            <div class="col-md-6">
              <label for=""><small>Tel 2</small></label>
              <input type="text" class="form-control" id="telefono_2" name="telefono_2" value="{{ $variables->telefono_2 }}">
            </div>
          </div>
          <center>
          <!-- BOTONES **************************************************************************-->
