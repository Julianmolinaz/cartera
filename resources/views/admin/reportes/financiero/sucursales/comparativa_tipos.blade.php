        ...
        <div class="panel-body">
          ...
          <div class="col-md-3">
                ...
                <div style="font-size:10px;">
                  Empresa: [{{ 'cant cred:' . $quart['empresa']['info']['num_creditos'] }}]
                </div>
                
                <div class="progress">
                
                  <div class="progress-bar progress-bar-danger" 
                      style="width: {{ $quart['empresa']['info']['porcien_0_1_pago'] }}%">
                    <span class="sr-only"></span>{{ $quart['empresa']['info']['porcien_0_1_pago'] }}
                  </div>
                
                  <div class="progress-bar progress-bar-warning progress-bar-striped" 
                    style="width: {{ $quart['empresa']['info']['porcien_promedio'] }}%">
                    <span class="sr-only"></span>{{ $quart['empresa']['info']['porcien_promedio'] }}
                  </div>

                  <div class="progress-bar progress-bar-success" 
                    style="width:  {{ $quart['empresa']['info']['porcien_ideales'] }}%">
                    <span class="sr-only"></span>{{ $quart['empresa']['info']['porcien_ideales'] }}
                  </div>
                </div> 
