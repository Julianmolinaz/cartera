        ...
        <div class="panel-body ref-body">
            <form @submit.prevent>
                ...
                <div class="col-md-4 col-sm-4 form-group">
                    ...
                    <input type="text" name="costo del credito" class="form-control" v-model="solicitud.vlr_fin">
                </div>
                <!-- CUOTA INICIAL -->
                <div class="col-md-2 col-sm-4 form-group">
                    <label for="cuota inicial">Cuota inicial</label>
                    <input type="text" name="cuota inicial" class="form-control" v-model="solicitud.cuota_inicial">
                </div>
                <!-- MESES -->
                <div class="col-md-2 col-sm-4 form-group">
                    <label for="meses">Meses</label>
                    <select name="meses" class="form-control" v-model="solicitud.meses">
                ...
                <div class="col-md-2 col-sm-4 form-group">
                    ...
                    <select class="form-control" v-model="solicitud.periodo">
                ...
                <div class="col-md-3 col-sm-4 form-group">
                    ...
                    <select class="form-control" v-model="solicitud.p_fecha">
                        <option value=""></option>
                    </select>
                </div>
                <!-- FECHA 2 -->
