@section('title','Crear Refinanciación')
...
<div class="col-md-2 col-sm-2"></div>
  ...
  <div class="panel panel-primary">
    <div class="panel-heading">Refinanciación cliente: 
    ...
    <div class="panel-body">
        ...
        <br />
        <!--FORMULARIO ********** -->
        <form class="form-horizontal form-label-left" action="{{route('start/creditos/crear_refinanciacion')}}" method="POST">
...
<!-- BOTONES **************************************************************************-->
    ...
    <center>
        ...
        <button type="submit" class="btn btn-danger">&nbsp;&nbsp;Crear Crédito&nbsp;&nbsp;</button>
    </center>    
