          ...
          <div class="form-group">  
            ...
            <div class="form-group">  
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <textarea class="form-control input-sm" rows="3" id="observaciones" name="observaciones" placeholder='Escriba las observaciones y recordatorios' autocomplete="on"  value="{{old('observaciones')}}">
                  {{old('observaciones')}}
                </textarea>
              </div>    
            </div> 
            ...
            <div class="form-group">  
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <textarea class="form-control input-sm" rows="4" id="ref_1" name="ref_1" placeholder='Escriba la referencia 1' 
                          autocomplete="on"  value="{{old('ref_1')}}">
                          {{old('ref_1')}}
                </textarea>
              </div>    
            </div> 
