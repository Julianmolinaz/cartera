        ...
        <!-- ROW 1 -->
         ...
         <!-- Funcionario -->
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <select class="form-control input-sm" name="funcionario_id" id="funcionario_id" required>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <select class="form-control input-sm" placeholder="Calificación Perfil Laboral" name="estLaboral_id" id="estLaboral_id" required>
                <option value="" readonly selected hidden="">- -</option>
          ...
          <!-- time_vivienda = Tiempo en Vivienda-->
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <select class="form-control input-sm" placeholder="" name="estVivienda_id" id="estVivienda_id" required>
                <option value="" readonly selected hidden="">- -</option>
          ...
          <div class="form-group">
            <div class="col-md-12 col-sm-12 col-xs-12">
              ...
              <select class="form-control input-sm" placeholder="" name="estReferencia_id" id="estReferencia_id" required>
                <option value="" readonly selected hidden="">- -</option>
          ...
          <div class="form-group">  
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <select class="form-control input-sm" placeholder="" name="estDatacredito_id" id="estDatacredito_id" required>
                <option value="" readonly selected hidden="">- -</option>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <label>Calificación Asesor *:</label>
                <input type="number" min="0" max="5" step="any" title="0 action 5" class="form-control input-sm" id="cal_asesor" name="cal_asesor"  autocomplete="off" placeholder="Ingrese un valor entre 0 y 5"  value="{{old('cal_asesor')}}" required>
              </div>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">  
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <textarea class="form-control input-sm" rows="4" id="ref_1" name="ref_1" placeholder='Escriba la referencia 1' 
