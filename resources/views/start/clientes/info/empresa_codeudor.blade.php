  ...
  <div class="">
    ...
    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
      <div class="panel-body" style="padding:0px;" >
            ...
            <p>Tipo de actividad: {{ $cliente->codeudor->tipo_actividadc  }}</p>
            <p>Empresa:   {{ $cliente->codeudor->empresac }}    </p>
            <p>Dirección: {{ $cliente->codeudor->dir_empresac}} </p>
            <p>Teléfonos: {{ $cliente->codeudor->tel_empresac}} </p>
