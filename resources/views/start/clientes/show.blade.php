...
<div class="row">
    ...
    <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1">
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
            @if($cliente->codeudor && $cliente->codeudor->version == 1)
                @include('start.clientes.info.codeudor')
            @elseif($cliente->codeudor && $cliente->codeudor->version == 2)
                @include('start.clientes.info.codeudor2')
            @else
                <div style="margin: 0px auto;
                    ...
                    <a href="{{route('start.codeudores.create',[$cliente->id])}}" 
