    ...
    <div class="panel-body">
        ...
        <form class="form-horizontal form-label-left" action="" method="POST">
            ...
            <div class="form-group">
			    ...
			    id="fecha_factura" 
                            v-model="general.fecha" 
			    onkeydown="return false"
			    :readonly="general.auto && user.rol != 'Administrador'">
                ...
                <div class="col-md-3 col-sm-3 col-xs-12" id="div_monto">
                    ...
                    <input 
                        ...
                        name="monto" 
                        id="monto" 
                        v-model="general.monto"
                        @keyup.enter="agregar"
                    >
                    <span class="help-block" v-if="general.monto">@{{ general.monto | miles }}</span>
                </div>
