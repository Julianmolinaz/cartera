...
<div class="panel panel-primary">
    ...
    <div class="panel-heading">Reporte Compras [ {{ $rango->ini->toDateString().' - '.$rango->end->toDateString()}} ]
        <button id="btn_exc_compras" class="btn btn-warning"><b>Exportar</b></button>
    </div>
</div>
...
<script>
    ...
    $('#btn_exc_compras').click(function(){
        $('#datatable').table2excel({
            name: 'Reporte',
            filename: "{{'compras'.$rango->ini->toDateString().'-a-'.$rango->end->toDateString().'.xls'}}"
        });
    });
