...
class CreateConyugesTable extends Migration {
	...
	public function up()
	{
		Schema::create('conyuges', function(Blueprint $table)
		{
			...
			$table->enum('tipo_docy', ['Cedula Ciudadanía','Nit','Cedula de Extranjería','Pasaporte','Pase Diplomático','Carnet Diplomático','Tarjeta de Identidad','Rut','Número único de Identificación Personal','Nit de Extranjería'])->default('Cedula Ciudadanía');
			$table->string('num_docy')->nullable();
			$table->string('diry');
			$table->string('movily');
