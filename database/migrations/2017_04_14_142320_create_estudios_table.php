...
class CreateEstudiosTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('estudios', function (Blueprint $table) {
            ...
            $table->integer('estDatacredito_id')->unsigned();
            $table->integer('estLaboral_id')->unsigned();
            $table->integer('estVivienda_id')->unsigned();
            $table->integer('estReferencia_id')->unsigned();
            $table->double('cal_asesor');
            $table->double('cal_estudio');
