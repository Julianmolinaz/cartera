        ...
        try {
            foreach( $this->data as $d ){
                ...
                $register = [
                    ...
                    '2.47-ciudad_res_com'       => cast_string(sanear_string($d->mun_reside_nombre),20),//ciudad de residencia del usuario
                    ...
                    '2.52-ciudad_laboral'       => cast_string(sanear_string($d->mun_cobro_nombre),20),
                    '2.53-cod_dane_ciudad_lab'  => cast_number($d->mun_cobro,8,'right'),
                    '2.54-departamento_laboral' => cast_string($d->depto_cobro,20),
                    '2.55-direccion_laboral'    => cast_string(sanear_string($d->dir_cobro),60),
                    '2.56-tel_laboral'          => cast_number($d->telefono,12,'right'),
                    '2.57-ciud_correspondencia' => cast_string(sanear_string($d->mun_reside_nombre),20),
